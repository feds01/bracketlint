//! Utilities that can be used by reports and or report constructors to nicely
//! format or automatically pluralise words.

use std::fmt;

// @@Todo: perhaps remove this in favour of fluent?
#[macro_export]
